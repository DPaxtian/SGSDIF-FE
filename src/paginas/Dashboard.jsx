  ...
  return (
    <Box p={10} height="100vh">
      <SimpleGrid columns={{ base: 2, md: 2 }} spacing={10} alignItems="center" justifyContent="center" height="full">
        ...
        <FeatureBox title="Aprobar solicitudes" icon={FaCheck} onBoxClick={() => handleBoxClick('/aprobar-solicitudes')} />
        <FeatureBox title="Generar reporte" icon={FaChartArea} onBoxClick={() => handleBoxClick('/generar-reporte')} />
        <FeatureBox title="Agregar apoyo al inventario" icon={FaDolly} onBoxClick={() => handleBoxClick('/agregar-apoyo-inventario')} />
      </SimpleGrid>
    </Box>
  );
};
